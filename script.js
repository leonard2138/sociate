...
function displayArticle(article) {
    ...
    if (isAdmin) {
        ...
        adminControls.style.marginTop = '1.3rem';
        
        const editBtn = document.createElement('button');
        editBtn.classList.add('edit-btn');
        editBtn.innerHTML = '<i class="fas fa-edit"></i><span class="btn-text">Редактировать</span>';
        ...
        deleteBtn.innerHTML = '<i class="fas fa-trash-alt"></i><span class="btn-text">Удалить</span>';
    ...
    posts.forEach((post, index) => {
        ...
        postElement.innerHTML = `
            ...
            <div class="post-footer">
                <a href="?id=${post.id}" class="read-more">Читать <span class="btn-text">полностью</span> <i class="fas fa-arrow-right"></i></a>
            </div>
        `;
...
function checkAdminStatus() {
    ...
    if (savedAdminStatus === 'true') {
        isAdmin = true;
        if (loginBtn) {
            loginBtn.innerHTML = '<i class="fas fa-user-shield"></i><span class="btn-text">Админ-панель</span>';
        }
    }
}
